...
<div style="background-color:#121E3B;height: 150px;width: 100%;top: 0;"> 
  <h1 style="padding-top: 85px;color: #e4e4e4">Terms & Conditions</h1>
</div>

<div class="container" style="width: 80%; margin-top:20px;padding-top: 20px;margin-bottom: 10px;">
	<div class="row">
		<div class="col-md-12 " style="float: left; padding: 0; text-align: justify;">
